...
const AgoraQueryEngine = ({ selectedContext, currentTheme, darkMode, minimal = false }) => {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0 }}>
      ...
      >
        ...
        <FormControl fullWidth size="small" sx={{ mb: 1.5 }}>
          <InputLabel id="agora-nlq-model-label" sx={{ color: theme?.textSecondary }}>
            Model
          </InputLabel>
          <Select
            labelId="agora-nlq-model-label"
            label="Model"
            value={nlModel}
          ...
          {!minimal && (
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1, flexWrap: 'wrap', gap: 1 }}>
              ...
              <FormControl size="small" sx={{ minWidth: 180 }}>
                <InputLabel id="agora-select-columns-label" sx={{ color: theme?.textSecondary }}>
                  Select columns
                </InputLabel>
                <Select
                  labelId="agora-select-columns-label"
...
export default AgoraQueryEngine;
