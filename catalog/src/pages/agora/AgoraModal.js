...
import AgoraExplorerTree from './AgoraExplorerTree';
import AgoraQueryEngine from './AgoraQueryEngine';
          ...
          <Box sx={{ flex: 1, overflow: 'auto', p: 2, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
            {selectedContext?.table?.id && selectedContext.table.id !== '_placeholder' ? (
              ...
              >
                ...
                >
                  Agora is your unified data query experience. Pick a model, dataset, and table from the sidebar, then write SQL or ask questions in natural language to query your data. Results are returned in the catalog so you can inspect, share, and govern access.
                </Typography>
                <Typography
                  variant="body2"
                  sx={{
